...
This app exposes a local HTTP API on port **37422** for integration with [Nova](https://github.com/kochj23) (OpenClaw AI) and Claude Code.
...
```bash
curl http://127.0.0.1:37422/api/status   # App status + uptime
curl http://127.0.0.1:37422/api/ping     # Health check
```
